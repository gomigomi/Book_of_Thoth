		...
		<div id="bot-wrapper">
			<div id="login-bot">
				<form name="form-login" id="form-login" method="POST" action="login.jsp">
					<div class="login-item">
						<i class="fa fa-user" style="padding-right:2%;"></i>
						<input class="login-input" type="text" name="id" placeholder="  Your ID" style="margin-left:1%; width:150; height:21; background-color:#eeeeee;border:1 solid red; font-family:굴림; font-size:10pt; color:green" onMouseOver="this.style.backgroundColor='white'" onMouseOut="this.style.backgroundColor='#eeeeee'"/>
					</div>
					<div class="login-item">
						<i class="fa fa-key" style="padding-right:2%;"></i>
						<input class="login-input" type="password" name="pw" placeholder="  Password" style="width:150; height:21; background-color:#eeeeee;border:1 solid red; font-family:굴림; font-size:10pt; color:green; margin-top:2%;" onMouseOver="this.style.backgroundColor='white'" onMouseOut="this.style.backgroundColor='#eeeeee'"/>
					</div>
			...
			<div id="signin-bot">
				<form name="form-sign" id="form-sign" method="POST" action="signin.jsp" enctype="multipart/form-data">
				    ...
				    <div class="signin-item"><i class="fa fa-key"></i></div><input class="signin-input" type="passwordConf" name="pwConf" id="pwConf" placeholder="  Your Password Confirm" style="margin-left:2%; width:150; height:21; background-color:#eeeeee;border:1 solid red; font-family:굴림; font-size:10pt; color:green; margin-top:1%;" onMouseOver="this.style.backgroundColor='white'" onMouseOut="this.style.backgroundColor='#eeeeee'"/>
